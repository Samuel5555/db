...
function error(){
    alert("Your account is not authenticated. Try creating an account.");
    window.location = 'home.html';
}
function error2(){
    alert("Please bear with us, we are still developing our account security package. Kindly subscribe below to get notified when the process is finished. Thanks. ");
    window.location = 'home.html';
}
